...
* We seek to examine whether some judges are harsher than others. Days of confinement were the metrics of judge harshness. Because judges are presented with different cases, linear regression was used to achieve fairer comparison among judges. 
