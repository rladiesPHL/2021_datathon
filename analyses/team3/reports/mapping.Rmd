...
- R color palletes: https://www.r-bloggers.com/2012/10/palettes-in-r/
...
How did the total number of charges change before and after?
...
pal <- colorNumeric( # no bins this time, just did a gradient of colors
  palette = "YlOrRd",
  domain = changes_merged$change
)
